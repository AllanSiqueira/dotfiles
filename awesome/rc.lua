...
beautiful.init("/home/allan/.config/awesome/theme.lua")
...
local net_indicator = net_widgets.wireless({interface = "wlp2s0"})
...
-- [WIP] Screenshot scrot scripts
--local cfgscrnshot = require("scrnshot")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control"   }, "q", function () awful.util.spawn("shutdown now")      end,
